  ...
  return (
    <div className={`mt-[15px] w-full ${!props.isDemo && 'ml-[-30px] min-h-screen sticky top-24 left-0 z-30'}`}>
      {videoSections.map((section: string, sectionIndex: number) => {
        ...
        return (
          <div className={`${!props.isDemo && 'border-b border-violet-500  pb-2'}`} key={section}>
                    ...
                    >
                      <div className="flex items-start ">
                        ...
                        <Icon
                          ...
                          className="text-violet-500 text-opacity-40 mr-2"
                          width="24"
                          height="24"
                        />
                        </div>
                        <h1 className="text-[18px] inline-block break-words text-white/70">
                          {item.title}
                        </h1>
                      </div>
                      <h5 className="pl-8 text-white/70">
