...
interface CourseListeningPracticeHubProps {
  courseId: string;
}
...
const mockCoursePractices = [
  {
    id: "1",
    title: "Business Meeting Audio Comprehension",
    description: "Listen to authentic business meeting recordings",
    type: "COMPREHENSION",
  ...
  {
    id: "3",
    title: "Presentation Listening Skills",
    description: "Comprehend business presentations and key points",
    type: "COMPREHENSION",
    difficulty: "ADVANCED",
...
export default function CourseListeningPracticeHub({ courseId }: CourseListeningPracticeHubProps) {
  ...
  useEffect(() => {
    ...
    // const practicesData = await fetchCourseListeningPractices(courseId);
    setPractices(mockCoursePractices);
  }, [courseId]);

  const handlePracticeClick = (practiceId: string) => {
    router.push(`/user/laboratory/listening/practice?courseId=${courseId}&practiceId=${practiceId}`);
  };
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-3xl font-bold mb-2 bg-gradient-to-r from-white via-orange-200 to-red-200 bg-clip-text text-transparent">
                {courseInfo.title}
              </h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <h2 className="text-2xl font-bold mb-2">Práticas de Listening</h2>
              <p className="text-gray-400">
                Exercícios de compreensão auditiva baseados no conteúdo do seu curso
              </p>
            </div>
            ...
            <div className="space-y-4">
              {practices.map((practice) => {
                ...
                return (
                  <Card
                    key={practice.id}
                    className="bg-customgreys-secondarybg border-orange-900/30 hover:border-orange-500/50 transition-all duration-300 cursor-pointer group"
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      <span className="text-gray-400">Listening Practice</span>
                      <span className="text-white">1/3 concluídas</span>
                    </div>
              ...
              <CardContent>
                <div className="text-center">
                  <div className="bg-orange-500/20 rounded-xl p-4 mb-4">
                    <Volume2 className="w-8 h-8 text-orange-400 mx-auto mb-2" />
                    <h4 className="font-semibold text-white mb-1">Advanced Listening</h4>
