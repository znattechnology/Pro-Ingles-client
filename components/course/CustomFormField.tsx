  ...
  const renderFormControl = (
    ...
    switch (type) {
      ...
      case "select":
        return (
          ...
          >
            ...
            <SelectContent className="w-full bg-customgreys-primarybg text-white border-customgreys-dirtyGrey shadow">
              {options?.map((option) => (
                <SelectItem
                  key={option.value}
                  value={option.value}
      ...
      case "file":
        ...
        return (
          <FilePond
            className={`${inputClassName}, text-white placeholder:text-white`}
      ...
      case "number":
        return (
          <Input
            ...
            placeholder={placeholder}
            {...field}
            className={`border-none bg-customgreys-darkGrey placeholder:text-white/70 p-4 text-white ${inputClassName}`}
            disabled={disabled}
          />
        );
      case "multi-input":
      ...
      default:
        return (
          <Input
            ...
            placeholder={placeholder}
            {...field}
            className={`border-none bg-customgreys-primarybg p-4 text-white ${inputClassName}`}
            disabled={disabled}
          />
        );
    }
