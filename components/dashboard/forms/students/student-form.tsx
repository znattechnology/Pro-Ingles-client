...
function SingleStudentForm({ editingId, initialData }: SingleStudentFormProps) {
  ...
  return (
    <form className="" onSubmit={handleSubmit(saveStudent)}>
      <Banner 
  variant="info" 
  message="Atualize suas informações de perfil." 
/>
      <FormHeader
        href="/students"
        parent=""
        ...
        <div className="lg:col-span-12 col-span-full space-y-3">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            <FormSelectInput
              ...
              toolTipText="Add Novo Encarregado"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            <PasswordInput
              ...
              errors={errors}
              placeholder=""
              toolTipText="Esta senha sera usada pelo estudante no portal do estudante"
            />
            <TextInput
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            />
            <TextArea
              label="Outras Informaçoes sobre o estudante."
              register={register}
              name="description"
              errors={errors}
            />
